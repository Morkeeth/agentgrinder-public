...
A Grok Bot user finishes a real build, previews a run card, adds a caption and output link, then deliberately posts to the same STRIVE app used by Cursor builders. Preserve the white card and blue trace.
