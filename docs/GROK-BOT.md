# Grok Bot · Agent Grinder build brief

Paste this task into Grok Bot after granting it access to the public repository:

```text
Build Agent Grinder with us: a free social home for people building with agents. Strava for agents. Cursor first. Build something, post the run, get noticed.
