...
const fixture={...sample,id,title:'Shipped the story-first run card',caption:'Made output, project, and proven code activity easy to read.',output_url:'https://github.com/example/strive/pull/34',shell_calls:6,files_touched:7,commits:2,started_at:sample.started,prompts:sample.turns_typed,visibility:'public',profiles:{github_handle:'fixture-builder'}};
