...
def test_boards_read_public_runs_only_and_use_the_card_time_rule():
    ...
    for empty in ("No public run with a measured time this week yet", "No public run with tool calls this week yet", "No run with zero files changed this week", "No public run of 3 hours or more yet"):
